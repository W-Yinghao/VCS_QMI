...
def main():
    ...
    ap.add_argument("--stages", default="P24_vcs_cosine_base,P26_vcs_negdetach_base,P28_vcs_new_candidates,P29_vcs_seedfill,P31_vcs_scale_init,P33_vcs_views_compute")
